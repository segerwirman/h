...
for _descriptor in (
    ...
    CapabilityDescriptor("selected_tab.observe", "selected_tab_observe", "selected_tab", "low", 20),
    CapabilityDescriptor("selected_tab.click", "selected_tab_click", "selected_tab", "medium", 30),
    CapabilityDescriptor("selected_tab.type", "selected_tab_type", "selected_tab", "medium", 30),
    CapabilityDescriptor("selected_tab.scroll", "selected_tab_scroll", "selected_tab", "medium", 30),
